...
@section('content')
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <h4 class="card-title">Order Lines</h4>
                            <div class="toolbar">
                             <div class="row">
                                <div class="col-md-12">
       ...
       {{--delete-modal--}}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" style="margin-bottom: 10px">Delete Order Lines</h4>
                    </div>
                    <div class="modal-body">
                         <p>Are you sure you want to delete this Order Lines?</p>
                    </div>
        ...
        <div class="modal fade" id="create-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
           {!! Form::open(['route' => 'orderLines.store']) !!}
               <div class="modal-dialog">
                   <div class="modal-content">
                       <div class="modal-header">
                           ...
                           <h4 class="modal-title">Create Order Lines</h4>
                       </div>
                       <div class="modal-body">
                           @include('order_lines.fields')
                       </div>
                       <div class="modal-footer">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Edit Order Lines</h4>
                    </div>
                    <div class="modal-body">
                        @include('order_lines.fields')
                    ...
                    <div class="modal-footer">
                         <input type="hidden" id="editDetails" value="{{ url("/order_lines") }}">
                        <button type="button" class="btn btn-simple" data-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-simple">Save</button>
                    </div>
                </div>
